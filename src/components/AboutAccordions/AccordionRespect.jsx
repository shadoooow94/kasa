...
export default function AccordionRespect() {
  //exportation de la fonction AccordionRespect qui retourne un composant AccordionRespect qui est un composant qui affiche les informations de la page à propos
