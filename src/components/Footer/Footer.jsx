...
export default function Footer() {
  //exportation de la fonction Footer qui retourne un composant Footer qui est un composant qui affiche le footer de la page
  return (
    ...
    <footer className="footerWrapper">
      <figure className="footerWrapper__fig">
        <img
          ...
          className="footerWrapper__fig__img"
        />
      </figure>
      <div className="footerWrapper__text">
        <img
          className="footerWrapper__copyright"
          src={copyright}
          alt="copyright"
        />
