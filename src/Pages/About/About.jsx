...
export default function About() { //exportation de la fonction About qui retourne un composant About qui est un composant qui affiche la page à propos  
  return (
    <div>       
      <AboutBanner/> 
      <Accordion title={'Fiabilité'} description={" Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conforment aux logements, et toutes les informations sont régulièrement vérifiées par nos équipes."} />
