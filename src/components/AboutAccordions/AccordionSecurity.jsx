...
export default function AccordionFiability() {
  //exportation de la fonction AccordionFiability qui retourne un composant AccordionFiability qui est un composant qui affiche le premier accordéon de la page à propos
