...
export default function LocationPage() { //exportation de la fonction LocationPage qui retourne un composant LocationPage qui est un composant qui affiche la page d'une location
  ...
  if(infoLocation !==undefined) { //si l'id de la location est trouvé dans le tableau Data alors on affiche la page de la location sinon on affiche la page d'erreur 404
  const { title , location, tags , host, rating, pictures, description, equipments} = infoLocation //décomposition des informations de la location dans des constantes pour pouvoir les utiliser dans le composant LocationPage
   return (
    ...
    <div>         
       ...
       <div className="location__collapse">
        ...
        <Accordion title={'Equipments'} description= {equipments.map ((equipment)=>{ //pour chaque équipement de la location on affiche une ligne de la liste
   ...
   }else{ //si l'id de la location n'est pas trouvé dans le tableau Data alors on affiche la page d'erreur 404
