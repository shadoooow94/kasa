...
export default function Home() {
  //exportation de la fonction Home qui retourne un composant Home qui est un composant qui affiche la page d'accueil du site

  return (
    //retourne le composant Home qui est un composant qui affiche la page d'accueil du site
    <div>
      <main>
        <div id="title">
          ...
          <img
            ...
            alt="banniere paysage"
            id="banner__responsive"
          />
        ...
        <div id="location">
          {Data.map(
            (
              card //map permet de parcourir le tableau Data et de créer une carte pour chaque élément du tableau
            ) => (
